...
var array = {
  ...
  updateElement: function updateElement(elem, index, reset) {
    ...
    ['outlierRadius', 'itemRadius', 'itemStyle', 'itemBackgroundColor', 'itemBorderColor', 'outlierColor', 'hitPadding'].forEach(function (item) {
      elem._model[item] = custom[item] !== undefined ? custom[item] : helpers.valueAtIndexOrDefault(dataset[item], index, options[item]);
    });
  },
...
var boxplot = _objectSpread({}, array, {
  ...
  updateElementGeometry: function updateElementGeometry(elem, index, reset) {
    controllers.bar.prototype.updateElementGeometry.call(this, elem, index, reset);
